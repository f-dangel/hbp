...
# torch layers
from torch.nn import Conv2d, Linear, MaxPool2d, ReLU, Sequential, Sigmoid
...
def torch_fn():
    ...
    return Sequential(
        ...
        ReLU(),
        MaxPool2d(kernel_size, stride=stride, padding=padding, dilation=dilation),
        Flatten(),
        Linear(out2_features, out3_features, bias=False),
        Sigmoid(),
...
def cvp_fn():
    ...
    return CVPSequential(
        ...
        CVPReLU(),
        CVPMaxPool2d(kernel_size, stride=stride, padding=padding, dilation=dilation),
        CVPFlatten(),

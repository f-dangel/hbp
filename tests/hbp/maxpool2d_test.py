...
def torch_fn():
    ...
    return MaxPool2d(kernel_size, stride=stride, padding=padding, dilation=dilation)


def hbp_fn():
    """Create a 2d max pool layer with HBP functionality."""
    return HBPMaxPool2d(kernel_size, stride=stride, padding=padding, dilation=dilation)

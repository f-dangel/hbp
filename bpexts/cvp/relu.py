"""Elementwise ReLU activation function with CVP functionality."""
...
class CVPReLU(cvp_elementwise_nonlinear(ReLU)):
    """Componentwise ReLU layer with CVP functionality.

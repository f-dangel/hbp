...
a = pandas.DataFrame(
    {"step": [1, 2], "wall": [0.1, 0.5], "value": [0.5, 0.4], "bar": [3.14159, 43]}
)
a_file = path.join(test_dir, "a.csv")
a.to_csv(a_file)

b = pandas.DataFrame(
    {"step": [1, 2], "wall": [1.1, 1.5], "value": [0.7, 1.2], "random": [13, 99]}
)
...
def test_load_and_rename_cols():
    ...
    result = pandas.DataFrame({"step": [1, 2], "renamed_value": [0.5, 0.4]})

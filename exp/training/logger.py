...
class Logger(TensorboardLogger):
    ...
    def print_tensorboard_instruction(self):
        ...
        print(
            ...
            " tensorboard --logdir {}\n".format(self.__logdir, self.__logdir)
        )
    ...
    def _scalars_to_pandas(cls, event_dir):
        ...
        event_acc.Reload()
        pandas_dict = {tag: data for (tag, data) in cls._extract_scalars(event_acc)}
        return pandas_dict
